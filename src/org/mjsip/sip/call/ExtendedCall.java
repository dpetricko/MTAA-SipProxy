...
public class ExtendedCall extends Call {
	...
	private void processDlgRefer(InviteDialog d, NameAddress refer_to, NameAddress referred_by, SipMessage msg) {
	...
	private void processDlgReferResponse(InviteDialog d, int code, String reason, SipMessage msg) {
		if (d!=dialog) {  log(LogLevel.INFO,"NOT the current dialog");  return;  }
	...
	private void processDlgNotify(InviteDialog d, String event, String sipfragment, SipMessage msg) {
		if (d!=dialog) {  log(LogLevel.INFO,"NOT the current dialog");  return;  }
	...
	private void processDlgAltRequest(InviteDialog d, String method, String body, SipMessage msg) {
		
	}

	/** From ExtendedInviteDialogListener. When a response is received for a request within the dialog 
	  * different from INVITE, CANCEL, ACK, BYE */ 
	private void processDlgAltResponse(InviteDialog d, String method, int code, String reason, String body, SipMessage msg) {
