...
public class TlsContext {
	...
	public void setKeyCert(String key_file, String cert_file) throws java.security.cert.CertificateException, java.io.FileNotFoundException, java.security.KeyStoreException, Exception {
	...
	public void setTrustAll(boolean trust_all) {
		...
		printOut("trust all: "+((trust_all)? "yes" : "no"));
